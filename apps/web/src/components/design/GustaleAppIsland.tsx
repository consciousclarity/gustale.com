...
const ModeIcon = ({ kind }) => {
  ...
  if (kind === "atlas")
    return (
      <svg viewBox="0 0 16 16" className="ic" {...s}>
        <circle cx="8" cy="8" r="6.2" />
        <path d="M8 1.8v12.4M1.8 8h12.4M3.2 4.4c1.4 1 7.2 1 9.6 0M3.2 11.6c1.4-1 7.2-1 9.6 0" />
      </svg>
    );
  if (kind === "index")
    return (
    ...
    <div className="idx-wrap">
      ...
      {dishes.map((d) => (
        <div className="idx-row" key={d.id}>
          ...
          <span className="org mono" style={{ fontSize: 12.5 }}>
            {d.type}
          </span>
          <span className="org mono" style={{ fontSize: 12.5 }}>
            {d.updated} ago
    ...
    <div className="gal">
      {dishes.map((d) => (
        <article className="gal-card" key={d.id}>
          <Ph
            label={`dish photo · ${d.name.toLowerCase()}`}
            h={230}
            t1={d.t1}
            t2={d.t2}
          />
          <h3>{d.name}</h3>
          <div className="place">
            {d.origin.toUpperCase()} · {d.country.toUpperCase()}
          </div>
          <p>{d.note}</p>
        </article>
      ))}
      ...
      {dishes.map((d) => (
        <article className="feed-card" key={d.id}>
          <div className="feed-img">
            <Ph
              label={`hero photo · ${d.name.toLowerCase()}`}
              h={"100%"}
              r={0}
              t1={d.t1}
              t2={d.t2}
              style={{ borderRadius: 0, minHeight: 280 }}
            />
          </div>
          <div className="feed-txt">
            ...
            <div className="feed-meta">
              <span>
                <b>{d.variants}</b> regional variants
              </span>
              <span>
                <b>{d.type}</b>
              </span>
...
function AtlasView({ dishes }) {
  ...
  const groups = window.REGION_ORDER.map((r) => [
    r,
    dishes.filter((d) => d.region === r),
  ]).filter(([, arr]) => arr.length);
  const proj = (d) => ({
    left: ((d.lon + 180) / 360) * 100,
    ...
    <div className="atl-grid">
      <div className="atl-map">
        ...
        <div className="atl-maplabel">
          ...
          <span>GUSTALE · ATLAS</span>
          <span>{dishes.length} PINS</span>
        </div>
      </div>
          ...
          <React.Fragment key={region}>
            ...
            {arr.map((d) => (
              ...
              >
                ...
                <span className="cd">
                  {d.lat.toFixed(1)}, {d.lon.toFixed(1)}
                </span>
              </div>
            ))}
          </React.Fragment>
...
function GustaleApp() {
  ...
  React.useEffect(() => {
    setMode(t.defaultView);
  }, [t.defaultView]);
  React.useEffect(() => {
    setDensity(t.defaultDensity);
  }, [t.defaultDensity]);
  ...
  const dishes = React.useMemo(() => {
    ...
    if (sort === "az") arr.sort((a, b) => a.name.localeCompare(b.name));
      ...
      arr.sort(
        (a, b) =>
          window.REGION_ORDER.indexOf(a.region) -
          window.REGION_ORDER.indexOf(b.region),
      );
    return arr;
  }, [sort]);
  ...
  return (
    <div
      className={"gst" + (t.display === "sans" ? " display-sans" : "")}
    ...
    >
      ...
      <nav className="gst-nav">
        <div className="wrap gst-nav-in">
          ...
          <div className="gst-navlinks">
            <a href="Gustale Atlas.html">Atlas</a>
            <a href="Gustale Families.html">Families</a>
            <a href="Gustale Dumpling Lineage.html">Lineages</a>
            <a href="Gustale Recipes.html">Recipes</a>
            <a href="Gustale About.html">About</a>
          </div>
          <div className="gst-navr">
            <a className="gst-ghost" href="Gustale Sign In.html">
              Sign in
            </a>
            <a className="btn-accent" href="Gustale Contribute.html">
              Contribute
            </a>
          </div>
        </div>
        ...
        <div className={"gst-hero" + (t.showMap ? "" : " no-map")}>
          <div>
            ...
            <p className="hero-lede">
              Gustale maps the world’s food to where it lives — origins,
              regional names, and the journeys that carried a recipe across
              borders. Then it lets you browse it your way.
            </p>
          ...
          {t.showMap && (
            <div className="hero-frame">
              <Ph
                label="map · world food density"
                h={400}
                t1="#E6D8BF"
                t2="#D9C8A8"
              />
              <div className="hero-coord">
                <span>LAT 41.90° N</span>
                <span>GUSTALE · ATLAS</span>
                <span>LON 12.50° E</span>
              </div>
            </div>
          )}
        </div>
      ...
      <section
        ...
        style={{ paddingTop: 8, paddingBottom: 30 }}
      >
        <div className="sec-rule">
          <h2>Three ways into the atlas</h2>
          <span>PLACE · FORM · PROVENANCE</span>
        </div>
        <div
          className="trend-row"
        ...
        >
          <a
            className="trend"
            href="Gustale Atlas.html"
            style={{ textDecoration: "none", color: "inherit" }}
          >
            <Ph
              label="map · world food atlas"
              h={150}
              r={0}
              t1="#E6D8BF"
              t2="#D9C8A8"
            ...
            <div className="body">
              ...
              <p>
                Pan a projected world map and follow dishes to exactly where
                they live.
              </p>
            </div>
          </a>
          <a
            className="trend"
            href="Gustale Families.html"
            style={{ textDecoration: "none", color: "inherit" }}
          >
            <Ph
              label="family · the shapes food takes"
              h={150}
              r={0}
              t1="#E5C277"
              t2="#D9B15C"
            ...
            <div className="body">
              ...
              <p>
                Before a dish has a country it has a form — dumpling, flatbread,
                egg dish.
              </p>
            </div>
          </a>
          <a
            className="trend"
            href="Gustale Dumpling Lineage.html"
            style={{ textDecoration: "none", color: "inherit" }}
          >
            <Ph
              label="lineage · migration routes"
              h={150}
              r={0}
              t1="#E4D2BC"
              t2="#D6C0A2"
            ...
            <div className="body">
              ...
              <p>
                Trace one idea across centuries of borders, names, and contested
                origins.
              </p>
            </div>
          </a>
      ...
      <section className="wrap section">
        <div className="sec-rule">
          <h2>Trending origins</h2>
          <a href="Gustale Regions.html">All 190 origins →</a>
        </div>
        <div className="trend-row">
          {TRENDING.map((tr) => (
            <article className="trend" key={tr.name}>
              <Ph
                label={`origin · ${tr.name.toLowerCase()}`}
                h={180}
                r={0}
                t1={tr.t1}
                t2={tr.t2}
      ...
      <section className="wrap section" style={{ paddingTop: 0 }}>
        <div className="feature">
          <div className="txt">
            ...
            <p>
              A pocket of dough around a filling appears on nearly every
              continent — shaped by climate, trade, and migration. Gustale
              connects them as a single family, so you can follow one idea told
              in a hundred kitchens.
            </p>
            <a
          ...
          <Ph
            label="hero photo · dumpling family"
            h={400}
            r={0}
            t1="#E4D2BC"
            t2="#D6C0A2"
      ...
      <section className="wrap section" style={{ paddingTop: 0 }}>
        <div className="sec-rule">
          ...
          <a href="Gustale Data.html">Open the API →</a>
        </div>
      ...
      <section className="wrap section" style={{ paddingTop: 0 }}>
        <div className="band">
          <div>
            ...
            <p>
              Gustale is built by cooks, writers, and travelers documenting the
              dishes they know best. Add a recipe, correct a name, or map a
              missing region.
            </p>
          </div>
          <div className="band-cta">
            <a
              href="Gustale Contribute.html"
              style={{
      ...
      <footer className="wrap gst-foot">
        ...
        <div className="fl">
          ...
          <a href="Gustale Dumpling Lineage.html">Lineages</a>
          <a href="Gustale Recipes.html">Recipes</a>
          <a href="Gustale Regions.html">Regions</a>
          <a href="Gustale Data.html">Data</a>
          <a href="Gustale About.html">About</a>
        </div>
      </footer>
      ...
      <TweaksPanel title="Tweaks">
        ...
        <TweakSelect
          ...
          value={t.defaultView}
          options={[
            { value: "atlas", label: "Atlas — by place" },
            { value: "index", label: "Index — by data" },
            { value: "gallery", label: "Gallery — by sight" },
            { value: "feed", label: "Feed — by story" },
          ]}
          onChange={(v) => setTweak("defaultView", v)}
        />
        <TweakRadio
          label="Default density"
          value={t.defaultDensity}
