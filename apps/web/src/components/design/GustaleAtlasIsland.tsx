...
export const ATLAS_DISHES: Dish[] = [
  {
    ...
    family: "Egg dishes",
    zone: "Africa",
    blurb: "Eggs poached in spiced tomato sauce",
    recipe: true,
  },
  {
    name: "Carbonara",
    ...
    family: "Pasta",
    zone: "Europe",
    blurb: "Pasta with egg, cheese, guanciale",
    recipe: true,
  },
  {
    name: "Pho",
    ...
    family: "Noodle soups",
    zone: "Asia",
    blurb: "Vietnamese beef noodle soup",
    recipe: true,
  },
  {
  ...
  },
  {
    ...
    family: "Seafood",
    zone: "Asia",
    blurb: "Vinegared rice with raw fish",
    recipe: true,
  },
  {
    name: "Butter Chicken",
    ...
    family: "Curries",
    zone: "Asia",
    blurb: "Murgh makhani in tomato butter sauce",
    recipe: true,
  },
  {
    name: "Paella",
  ...
  },
  {
    ...
    lon: 126.98,
    region: "East Asia",
    family: "Fermented foods",
    zone: "Asia",
    blurb: "Spicy fermented vegetables",
    recipe: true,
  },
  {
    name: "Moussaka",
    ...
    family: "Cassroles",
    zone: "Europe",
    blurb: "Layered eggplant with meat",
    recipe: true,
  },
  {
    name: "Jollof Rice",
    ...
    family: "Rice dishes",
    zone: "Africa",
    blurb: "Tomato rice with peppers",
    recipe: true,
  },
  {
    name: "Ramen",
    ...
    family: "Noodle soups",
    zone: "Asia",
    blurb: "wheat noodles in rich broth",
    recipe: true,
  },
  {
    name: "Feijoada",
    ...
    family: "Stews",
    zone: "Americas",
    blurb: "Black bean and pork stew",
    recipe: true,
  },
  {
    name: "Pierogi",
    ...
    family: "Dumplings",
    zone: "Europe",
    blurb: "Stuffed pasta with various fillings",
    recipe: true,
  },
  {
    name: "Couscous",
    ...
    family: "Grains",
    zone: "Africa",
    blurb: "Steamed semolina granules",
    recipe: true,
  },
  {
    name: "Pad Thai",
    ...
    family: "Noodles",
    zone: "Asia",
    blurb: "Stir-fried rice noodles with tamarind",
    recipe: true,
  },
  {
    name: "Bouillabaisse",
  ...
  },
  {
    ...
    family: "Pasta",
    zone: "Europe",
    blurb: "Layered pasta with ragù and béchamel",
    recipe: true,
  },
  {
    name: "Kebab",
    ...
    family: "Street foods",
    zone: "Europe",
    blurb: "Grilled minced meat on skewers",
    recipe: true,
  },
  {
    name: "Tagine",
    ...
    family: "Stews",
    zone: "Africa",
    blurb: "Slow-cooked spiced meat and vegetables",
    recipe: true,
  },
  {
    name: "Ravioli",
  ...
  },
  {
    ...
    family: "Rice dishes",
    zone: "Asia",
    blurb: "Aromatic layered rice with meat",
    recipe: true,
  },
  {
    name: "Hummus",
    ...
    family: "Dips",
    zone: "Asia",
    blurb: "Chickpea and tahini spread",
    recipe: true,
  },
  {
    name: "Tiramisu",
    ...
    family: "Desserts",
    zone: "Europe",
    blurb: "Coffee-soaked ladyfingers with mascarpone",
    recipe: true,
  },
  {
    name: "Peking Duck",
    ...
    family: "Poultry",
    zone: "Asia",
    blurb: "Crispy roasted duck with pancakes",
    recipe: true,
  },
  {
    name: "Baklava",
    ...
    family: "Desserts",
    zone: "Europe",
    blurb: "Layered phyllo with nuts and honey",
    recipe: true,
  },
];
...
const TONE_VARS = {
  parchment: {
    water: "#EFE7D5",
    land: "#E0D0B0",
    mapline: "rgba(33,28,22,0.13)",
    landstroke: "rgba(33,28,22,0.18)",
  },
  sea: {
    water: "#CFE0DD",
    land: "#E7D9BD",
    mapline: "rgba(33,28,22,0.10)",
    landstroke: "rgba(33,28,22,0.18)",
  },
  night: {
    water: "#211C18",
    land: "#38302A",
    mapline: "rgba(243,234,221,0.10)",
    landstroke: "rgba(243,234,221,0.16)",
  },
};
    ...
    <div className="map-box" data-tone={settings.mapTone}>
      ...
      {ATLAS_DISHES.map((dish) => {
        ...
        return (
          ...
          >
            <div className="ring" style={{ backgroundColor: color }} />
      ...
      <div className="map-caption">
        {ATLAS_DISHES.length} dishes · {Object.keys(FAMILY_COLORS).length}{" "}
        families
      </div>
    </div>
  );
